...
public enum EscolaEnum {
	...
	FATEMP("Escola básica municipal Palhoca","Centro Palhoça",BairroEnum.PALHOCA_CENTRO),
	VIVIANE_LAURITA("Viviane Laurita","Centro Palhoça",BairroEnum.PALHOCA_CENTRO),
	ESPACO_PACHECO("Espaço Pacheco","Pacheco",BairroEnum.PACHECOS),
	PEDRO_IVO("PEDRO IVO","Centro Palhoca",BairroEnum.PALHOCA_CENTRO),
	ANJINHO_GUARDA("Anjinho Guarda","Pacheco",BairroEnum.PACHECOS),
	ANTONIETA("Antonieta","Guarda",BairroEnum.GUARDA);
