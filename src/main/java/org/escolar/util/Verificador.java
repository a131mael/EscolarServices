...
public class Verificador {
	...
	public static Double getJurosMulta(org.escolar.model.Boleto boleto) {
		Calendar tomorrow = Calendar.getInstance();
		tomorrow.set(Calendar.DAY_OF_MONTH, tomorrow.get(Calendar.DAY_OF_MONTH) + 1);
	...
	public static String getStatus(org.escolar.model.Boleto boleto) {
		return getStatusEnum(boleto).getName();
	}
	
	public static StatusBoletoEnum getStatusEnum(org.escolar.model.Boleto boleto) {
		Calendar tomorrow = Calendar.getInstance();
	...
	private static boolean pago(org.escolar.model.Boleto boleto) {
	...
	private static boolean baixado(org.escolar.model.Boleto boleto) {
	...
	private static boolean cancelado(org.escolar.model.Boleto boleto) {
